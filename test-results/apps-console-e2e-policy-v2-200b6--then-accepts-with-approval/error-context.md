...
- Name: apps/console/e2e/policy-v2-critical-flows.spec.ts >> Flow D: Destructive gate rejects promotion before simulation, then accepts with approval
- Location: apps/console/e2e/policy-v2-critical-flows.spec.ts:569:1
