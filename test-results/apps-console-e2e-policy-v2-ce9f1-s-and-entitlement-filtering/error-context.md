...
- Name: apps/console/e2e/policy-v2-critical-flows.spec.ts >> Flow C: Agent fetch includes semantic/genai modules and entitlement filtering
- Location: apps/console/e2e/policy-v2-critical-flows.spec.ts:541:1
